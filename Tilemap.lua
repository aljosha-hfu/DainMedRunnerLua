...
function Tilemap:create()
    ...
    local obstaclePercentage = love.math.random(2, 10)
...
-- returns the position in the Tilemap of a tile at a specific x,y coordinate
...
function generateQuads(atlas, tilewidth, tileheight)
    ...
    for y = 0, sheetHeight - 1 do
        for x = 0, sheetWidth - 1 do
            -- this quad represents a square cutout of the atlas
            quads[sheetCounter] =
...
function Tilemap:collides(tile)
    ...
    -- all objects the player can "walk" on
    local collidables = {
        TILE_GRASS_TOP,
        TILE_GAP_TOP_LEFT,
        TILE_GAP_TOP_RIGHT,
